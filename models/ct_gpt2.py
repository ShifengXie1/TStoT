...
class CTGPT2Forecasting(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.forecaster = ContinuousGPT2Forecaster(
            ...
            use_token_distribution_loss=getattr(configs, "use_token_distribution_loss", True),
            token_distribution_samples=getattr(configs, "token_distribution_samples", 256),
            token_distribution_bandwidth=getattr(configs, "token_distribution_bandwidth", 1.0),
            token_moment_weight=getattr(configs, "token_moment_weight", 0.1),
