...
def build_args():
    ...
    parser.add_argument("--decoder_hidden_dim", type=int, default=0)
    parser.add_argument("--num_output_mixtures", type=int, default=1)
    parser.add_argument("--num_sampling_paths", type=int, default=0)
    parser.add_argument("--min_log_variance", type=float, default=-10.0)
    parser.add_argument("--max_log_variance", type=float, default=5.0)
    parser.add_argument("--use_alignment", type=str2bool, default=False)
    parser.add_argument("--alignment_hidden_dim", type=int, default=0)
    ...
    parser.add_argument("--lambda_trend", type=float, default=0.0)
